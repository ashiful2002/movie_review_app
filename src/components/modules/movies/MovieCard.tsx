...
import { Star, Eye, Play, X, Lock } from "lucide-react";
        ...
        <CardHeader className="p-0 relative">
          <div className="relative w-full aspect-[2/3] overflow-hidden">
            ...
            <div className="absolute inset-0 bg-[#0E0F13]/0 group-hover:bg-[#0E0F13]/50 transition-colors flex items-center justify-center">
              {trailerId && (
                <button
                  ...
                  className="w-11 h-11 rounded-full bg-yellow-400 flex items-center justify-center opacity-0 group-hover:opacity-100 scale-75 group-hover:scale-100 transition-all"
            ...
            <div className="absolute top-2.5 left-2.5 flex flex-col gap-1.5">
              ...
              {movie.isPremium && (
                <Badge className="rounded-none px-2 py-0.5 text-[10px] font-mono tracking-widest uppercase bg-[#D4A24C] text-[#0E0F13] border-0 gap-1">
