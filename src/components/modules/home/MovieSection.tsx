import AdvancedHomeSections from "@/components/modules/home/AdvancedHomeSections";
  ...
  return (
    <div className="">
      <div className="mb-12 text-center">
        <h2 className="mt-4 text-4xl font-bold">Latest Movies</h2>
        <p className="mx-auto mt-4 max-w-2xl text-muted-foreground">
          Here is 10 <span className="text-yellow-400">MMDB</span> Latest Movies
        </p>
      </div>
      ...
      {movies.length > 0 && (
        <div className="flex items-center justify-center mt-4">
          <Link href="/movies">
            <Button className="group cursor-pointer flex items-center gap-2 bg-yellow-400 hover:bg-yellow-500">
              View All
