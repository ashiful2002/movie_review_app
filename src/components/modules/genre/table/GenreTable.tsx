...
export default function GenreTableAdvanced({ genres }: { genres: Genre[] }) {
  ...
  const toggleSelectAll = () => {
    if (selectedIds.size === filteredAndSortedGenres.length) {
      ...
      setSelectedIds(
        new Set(filteredAndSortedGenres.map((g) => g.id))
      );
    }
  };
            ...
            <table className="w-full">
                ...
                <tr>
                  ...
                  <th className="px-6 py-3 text-left">
                    <button
                      ...
                      className="flex items-center gap-2 font-semibold text-gray-200 hover:text-gray-900"
                    >
                      Name <SortIcon column="name" />
                    </button>
                  </th>
                  <th className="px-6 py-3 text-left font-semibold text-gray-200">
                    Image
                  </th>
                  <th className="px-6 py-3 text-left">
                    <button
              ...
              <tbody className="divide-y">
                {filteredAndSortedGenres.map((genre) => (
                  <tr
                    key={genre.id}
                    className={`hover:bg-gray-50 transition-colors ${selectedIds.has(genre.id) ? "bg-blue-50" : ""
                      }`}
                  >
                    ...
                    <td className="px-6 py-4">
                      <div className="flex items-center gap-3">
                        <a
                          ...
                          className="inline-flex items-center gap-1 text-blue-600 hover:text-blue-800 hover:bg-blue-50 px-3 py-1 rounded transition-colors"
                          title="Edit"
                        >
