        ...
        <div className="overflow-hidden rounded-lg border">
            <table className="w-full">
                <thead className="bg-muted px-20">
                    <tr className="">
                        <th className="px-5 py-3 text-left text-sm font-semibold">Thumbnail</th>
                        ...
                        <th className="px-5 py-3 text-right text-sm font-semibold">Action</th>
                    </tr>
                </thead>
                        ...
                        <tr key={item.id} className="border-t hover:bg-muted/50 transition">
                            ...
                            <td className="px-5 py-4">
                                <span className="inline-flex items-center gap-1">
                                    <span>⭐</span>
                                    <span className="font-medium">{item.movie.rating.toFixed(1)}</span>
                                </span>
                            </td>
