...
export default function AboutPage() {
  return (
    <div className="flex flex-col min-h-screen">
      {/* Hero Section */}
      <section className="relative py-20 lg:py-32 overflow-hidden rounded-b-3xl mt-12">
        ...
        <div className="container relative z-10 px-4 md:px-6 mx-auto text-center">
          ...
          <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto leading-relaxed">
            MMDB is the ultimate destination for cinephiles. We bring you the
            most accurate ratings, insightful reviews, and a community of movie
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto text-lg">
              To create a transparent, engaging, and comprehensive platform
              where every movie finds its audience and every viewer finds their
              next favorite film.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <Card className="bg-background/50 backdrop-blur-sm border-primary/10 shadow-lg hover:shadow-xl transition-all duration-500 hover:-translate-y-2 group">
              <CardContent className="p-8 text-center flex flex-col items-center">
                ...
                <p className="text-muted-foreground text-sm leading-relaxed">
                  We believe in real opinions from real people. Our review
                  system ensures authenticity and helps you make the best watch
                  decisions.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="bg-background/50 backdrop-blur-sm border-primary/10 shadow-lg hover:shadow-xl transition-all duration-500 hover:-translate-y-2 group">
              <CardContent className="p-8 text-center flex flex-col items-center">
                ...
                <p className="text-muted-foreground text-sm leading-relaxed">
                  Join thousands of movie enthusiasts worldwide. Discuss, rate,
                  and share your passion for cinema with a community that cares.
                </p>
              </CardContent>
            </Card>
      ...
      {/* Stats Section */}
      <section className="py-20 bg-primary/5 rounded-3xl mx-4 mb-20 mt-12">
        <div className="container mx-auto px-4 md:px-6">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 divide-x divide-primary/10">
            <div className="flex flex-col items-center justify-center space-y-2">
              <h4 className="text-4xl md:text-5xl font-black text-primary">
                10K+
              </h4>
            ...
            <div className="flex flex-col items-center justify-center space-y-2">
              <h4 className="text-4xl md:text-5xl font-black text-yellow-500">
                50K+
              </h4>
              <p className="text-sm text-muted-foreground font-medium uppercase tracking-wider text-center">
                Active Users
            ...
            <div className="flex flex-col items-center justify-center space-y-2">
              <h4 className="text-4xl md:text-5xl font-black text-blue-500">
                2M+
              </h4>
              <p className="text-sm text-muted-foreground font-medium uppercase tracking-wider text-center">
                Reviews Written
            ...
            <div className="flex flex-col items-center justify-center space-y-2">
              <h4 className="text-4xl md:text-5xl font-black text-green-500">
                99%
              </h4>
              <p className="text-sm text-muted-foreground font-medium uppercase tracking-wider text-center">
                Satisfaction
