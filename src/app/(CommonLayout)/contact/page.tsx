            ...
            <Card className="border-primary/10 shadow-md hover:shadow-lg transition-shadow">
              <CardContent className="p-6 flex items-start gap-4">
                ...
                <div>
                  ...
                  <a href="mailto:support@mmdb.com" className="text-primary font-medium hover:underline">
                    support@mmdb.com
                  </a>
                </div>
              </CardContent>
            ...
            <Card className="border-primary/10 shadow-md hover:shadow-lg transition-shadow">
              <CardContent className="p-6 flex items-start gap-4">
                ...
                <div>
                  ...
                  <a href="tel:01759907907" className="text-primary font-medium hover:underline">
                    01759-907907
                  </a>
                </div>
              </CardContent>
                ...
                <form className="space-y-6">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="space-y-2">
                      ...
                      <Input id="firstName" placeholder="John" className="bg-background/50 focus:bg-background transition-colors" />
                    </div>
                    <div className="space-y-2">
                      <label htmlFor="lastName" className="text-sm font-medium">Last Name</label>
                      <Input id="lastName" placeholder="Doe" className="bg-background/50 focus:bg-background transition-colors" />
                    </div>
                  </div>
                  
                  <div className="space-y-2">
                    <label htmlFor="email" className="text-sm font-medium">Email Address</label>
                    <Input id="email" type="email" placeholder="john@example.com" className="bg-background/50 focus:bg-background transition-colors" />
                  </div>

                  <div className="space-y-2">
                    <label htmlFor="subject" className="text-sm font-medium">Subject</label>
                    <Input id="subject" placeholder="How can we help?" className="bg-background/50 focus:bg-background transition-colors" />
                  </div>
                  ...
                  <Button type="button" className="w-full sm:w-auto px-8 gap-2 hover:scale-105 transition-transform duration-300">
                    Send Message
